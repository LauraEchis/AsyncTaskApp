...
class StarshipsAdapter(val context: Context, val starships: List<Starship>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        lengthText.text = "Length: " + starships[position].length

        val max_atmosphering_speedText = rowView!!.findViewById<TextView>(R.id.max_atmosphering_speed)
        max_atmosphering_speedText.text = "Max atm. speed: " + starships[position].max_atmosphering_speed
        ...
        val starship_classText = rowView!!.findViewById<TextView>(R.id.starships_class)
